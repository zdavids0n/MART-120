...
var diameters=[];
 ...
 function setup() {
  ...
  for(var i=0;i<15;i++){
    rectXsSpeed[i]=Math.floor(Math.random()*(Math.floor(Math.random()*6))+1);
    rectYsSpeed[i]=Math.floor(Math.random()*(Math.floor(Math.random()*6))+1);
    rectXs[i]=getRandomNumber(300);
    rectYs[i]=getRandomNumber(400);
...
function draw() {
  ...
  for(var i=0;i<rectXs.length;i++){
    fill(100,33,22);
    circle(rectXs[i],rectYs[i],diameters[i]);
    rectXsSpeed[i]=Math.floor(Math.random()*(Math.floor(Math.random()*6))+1);
    rectYsSpeed[i]=Math.floor(Math.random()*(Math.floor(Math.random()*6))+1);
    rectXs[i]+=rectXsSpeed[i];
rectYs[i]+=rectYsSpeed[i];
if(rectXs[i]>width){
  rectXs[i]=0;
}
if(rectXs[i]<0){
